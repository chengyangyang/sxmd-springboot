...
/**
 * Description: 自定义解码器 对LengthFieldBasedFrameDecoder进行改造
 *
 * @author cy
 * @date 2019年10月08日 14:01
 * Version 1.0
 */
    ...
    protected long getUnadjustedFrameLength(ByteBuf buf, int offset, int length, ByteOrder order) {
        ...
        switch (length) {
            ...
            case 2:
                ...
                lenBytes[1] = buf.getByte(offset);
                lenBytes[0] = buf.getByte(offset + 1);
                // 数据内容长度
                frameLength = Convert.hexByteToInt(lenBytes);
